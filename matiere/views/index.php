<div class="dtitle w3-container w3-teal w3-center w3-padding-32">
    <h1 class="w3-xxlarge w3-text-white">Accueil Matiere</h1>
</div>
...
<div class="w3-container w3-padding-large w3-light-grey">
    <div class="classement-general w3-card w3-white w3-margin-bottom">
        <div class="w3-container w3-teal w3-padding-16">
            <h2 class="w3-xxlarge w3-text-white w3-center">Classement Général</h2>
        </div>
        <div class="w3-responsive">
            <table class="w3-table w3-bordered w3-striped w3-hoverable">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="w3-center w3-text-grey">Aucun résultat disponible.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div class="classement-epreuve w3-card w3-white">
        <div class="w3-container w3-blue w3-padding-16">
            <h2 class="w3-xxlarge w3-text-white w3-center">Classement par Épreuve</h2>
        </div>
        <div class="w3-responsive">
            <table class="w3-table w3-bordered w3-striped w3-hoverable">
                <thead>
                ...
                <tbody>
                    <?php if (!empty($classementParEpreuve)): ?>
                        <?php foreach ($classementParEpreuve as $epreuve): ?>
                            <tr>
                                <td><?= htmlspecialchars($epreuve['matiere']) ?></td>
                                <td><?= htmlspecialchars($epreuve['epreuve']) ?></td>
